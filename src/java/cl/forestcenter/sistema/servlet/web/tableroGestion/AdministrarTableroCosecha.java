 ...
 * @author jjara
 */
public class AdministrarTableroCosecha extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (cLogin.validarSesion(req.getSession().getAttribute("idUsuario").toString(), req.getSession().getId())) {
            ...
            if (req.getParameter("accion") != null && !req.getParameter("accion").equals("")) {
                if (req.getParameter("accion").equals("HTML_TABLA_COSECHA_FORWARDER")) {
                    htmlTablaCosechaForwarder(req, res);
                } else if (req.getParameter("accion").equals("HTML_TABLA_COSECHA_HARVESTER")) {
                    htmlTablaCosechaHarvester(req, res);
                } else if (req.getParameter("accion").equals("DATOS_GRAFICO_COSECHA_FORWARDER")) {
                    obtenerDatosGraficoForwarder(req, res);
                } else if (req.getParameter("accion").equals("DATOS_GRAFICO_COSECHA_HARVESTER")) {
                    obtenerDatosGraficoHarvester(req, res);
                }
            } else {
                pagina = "/web/tableroGestion/cosecha/administrarTableroCosecha.jsp";
    ...
    private void htmlTablaCosechaForwarder(HttpServletRequest req, HttpServletResponse res) {        
        ...
        //mas codigo
        listaResultado = cRegistroForwarder.getResumenResultadosForwarder("Cosecha");//i x mes
        ...
        listaPotenciales = cRegistroForwarder.getResumenPotencialesForwarder("Cosecha");//i x mes
    ...
    private void htmlTablaCosechaHarvester(HttpServletRequest req, HttpServletResponse res) {
        //CONTENIDO RESULTADOS
        ...
        //mas codigo
        listaResultado = cRegistroHarvester.getResumenResultadosHarvester("Cosecha");//i x mes
        ...
        listaPotenciales = cRegistroHarvester.getResumenPotencialesHarvester("Cosecha");//i x mes
